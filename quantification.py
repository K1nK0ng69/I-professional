...
def solve():
    ...
    # Определяем оптимальные значения для квантования в зависимости от x0, x1, x2
    y1 = 0.31681 * (x0 / 2)  # Примерный коэффициент с учетом x0
    y2 = 0.42933 * (x1 / 2)  # Примерный коэффициент с учетом x1
    y3 = 0.84576 * (x2 / 2)  # Примерный коэффициент с учетом x2
